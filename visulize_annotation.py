...
#%% 
output_dir ='/mnt/hdd_bob/syy/adipose/atac/res/AB_ATAC_FL_TAM_SQ'
...
ax.legend( loc='upper right', bbox_to_anchor=(1.5, .6))
...
freq_df.plot(kind='bar', figsize=(10, 6), width=0.8, alpha=0.7, ax=ax)
...
# peaks_annStat = pd.read_csv(os.path.join(annotation_dir, 'annStats_peaks.txt'), \
#     index_col=0, sep='\t')

# entropy_peaks_annStat = pd.read_csv(os.path.join(annotation_dir, 'annStats_entropy_peaks.txt'), \
#     index_col=0, sep='\t')
# %%
